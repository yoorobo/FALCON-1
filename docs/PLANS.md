...
| 계획 | 상태 | 시작일 | 파일 |
|---|---|---|---|
| 하네스 엔지니어링 시스템 구축 | 🟡 진행 중 | 2026-05-05 | `exec-plans/active/` |
| 상세설계 / SR 후속 계획 묶음 | 🟡 진행 중 | 2026-05-06 | `exec-plans/active/` |

## 완료 (Completed)

| 계획 | 완료일 | 파일 |
|---|---|---|
| exec-plan-001 | 2026-04-28 | [exec-plan-001](exec-plans/completed/2026-04-28-exec-plan-001.md) |
| exec-plan-002 | 2026-04-28 | [exec-plan-002](exec-plans/completed/2026-04-28-exec-plan-002.md) |
...
> 새 계획 추가 시 이 목록을 업데이트할 것.
> 완료된 계획은 `exec-plans/completed/`로 이동 후 여기에도 반영.
